...
PHASE_B_PATIENCE="${PHASE_B_PATIENCE:-4}"
...
COMMON_ARGS=(
  ...
  loss.component_match_center_weight=0.25
  loss.component_unmatched_weight=0.25
...
run_phase_b() {
  ...
  local cmd=(
    ...
    "callbacks.early_stopping.patience=${PHASE_B_PATIENCE}"
    "++callbacks.early_stopping.min_delta=0.001"
